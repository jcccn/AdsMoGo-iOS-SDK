...
- (void) initializeCustomFrameParameters:(NSInteger)customFrameSupport withCustomFrameImage:(UIImage *)customFrameImage andCloseButtonImage:(UIImage *)closeButtonImage;
