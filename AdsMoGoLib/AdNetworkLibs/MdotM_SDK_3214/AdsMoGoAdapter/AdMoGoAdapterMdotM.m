...
- (void)getAd {
    ...
    id testmodel  = [self.ration objectForKey:@"testmodel"];
    if ([testmodel isKindOfClass:[NSString class]]) {
        requestParameters.test = testmodel;
    }else if ([testmodel isKindOfClass:[NSNumber class]]){
        requestParameters.test = [testmodel stringValue];
    }
