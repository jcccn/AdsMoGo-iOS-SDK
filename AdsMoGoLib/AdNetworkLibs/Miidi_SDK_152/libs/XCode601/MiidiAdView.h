...
+ (MiidiAdView *)createMiidiBasAdViewWithSizeIdentifier:(MiidiAdSizeIdentifier)adSizeIdentifier withMiidiBasDelegate:(id<MiidiAdViewDelegate>)delegate;
- (id)initMiidiBasAdViewWithContentSizeIdentifier:(MiidiAdSizeIdentifier)adSizeIdentifier withMiidiBasDelegate:(id<MiidiAdViewDelegate>)delegate;

- (void) requestMiidiBasAd;
@end
