...
//            break;
    ...
    dmAdView = [[DMAdView alloc] initWithPublisherId:publishId
                                 ...
                                 size:size
                                 autorefresh:NO];
//    if(type == AdViewTypeiPadSmartBanner ||
//       type == AdViewTypeiPhoneSmartBanner){
//        if (UIInterfaceOrientationIsPortrait([UIApplication sharedApplication].statusBarOrientation) ) {
//            dmAdView.frame = CGRectMake(0.0, 0.0, FLEXIBLE_SIZE_PORTRAIT.width,
//                                        FLEXIBLE_SIZE_PORTRAIT.height);
//        }else{
//            dmAdView.frame = CGRectMake(0.0, 0.0, FLEXIBLE_SIZE_LANDSCAPE.width,
