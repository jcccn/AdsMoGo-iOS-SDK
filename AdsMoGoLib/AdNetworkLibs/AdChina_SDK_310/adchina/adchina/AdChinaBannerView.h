...
#define BannerSizeDefault		(isPhone? CGSizeMake(320, 50) : CGSizeMake(640, 100))
#define BannerSizeSquare        (isPhone? CGSizeMake(320, 50) : CGSizeMake(360, 360))
#define BannerSizeVertical      (isPhone? CGSizeMake(320, 50) : CGSizeMake(336, 480))
#define BannerSizeVideo         (isPhone? CGSizeMake(320, 50) : CGSizeMake(480, 360))    
