...
-(void)presentInterstitial{
	...
	if (type == AdViewTypeFullScreen ||
        ...
        self.interstitialView = [AdChinaInterstitialView requestAdWithAdSpaceId:[self.ration objectForKey:@"key" ] delegate:self shouldAutoPlay:NO];
...
- (void)didGetInterstitialAd:(AdChinaInterstitialView *)adView{
    ...
    if ([UIApplication sharedApplication].keyWindow.rootViewController) {
        ...
        baseviewController= [self.adMoGoInterstitialDelegate viewControllerForPresentingInterstitialModalView];
    }
