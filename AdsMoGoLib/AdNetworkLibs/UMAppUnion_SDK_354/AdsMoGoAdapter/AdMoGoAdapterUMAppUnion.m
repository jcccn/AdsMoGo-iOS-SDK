...
#import "AdMoGoAdapterUMAppUnion.h"
#import "AdMoGoAdNetworkRegistry.h"
#import "AdMoGoAdNetworkConfig.h"

@implementation AdMoGoAdapterUMAppUnion

//+ (NSDictionary *)networkType {
//    return [self makeNetWorkType:AdMoGoAdNetworkTypeUMAppUnion IsSDK:YES isApi:NO isBanner:YES isFullScreen:NO];
//}
//
//+ (void)load {
...
+ (AdMoGoAdNetworkType)networkType{
    return AdMoGoAdNetworkTypeUMAppUnion;
}
...
//    timer = [[NSTimer scheduledTimerWithTimeInterval:AdapterTimeOut5 target:self selector:@selector(loadAdTimeOut:) userInfo:nil repeats:NO] retain];
    ...
    adView = [[UMUFPBannerView alloc] initWithFrame:CGRectMake(0, 0, size.width, size.height) appKey:[self.ration objectForKey:@"key"] slotId:nil currentViewController:[self.adMoGoDelegate viewControllerForPresentingModalView]];
