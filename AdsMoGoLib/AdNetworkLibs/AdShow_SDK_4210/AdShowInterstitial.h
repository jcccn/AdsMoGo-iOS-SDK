...
#pragma mark -
#pragma mark AdShowInterstitialDelegate
@protocol AdShowInterstitialDelegate <AdShowBannerDelegate>
@optional
...
@interface AdShowInterstitial : NSObject<AdShowInterstitialDelegate>
{
}
@property (nonatomic, assign) NSObject<AdShowInterstitialDelegate> *delegate;
