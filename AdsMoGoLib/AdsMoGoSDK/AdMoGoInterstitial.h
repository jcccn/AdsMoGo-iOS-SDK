...
/*
 初始化
 默认轮换 没有轮换间隔时间
 如果调用此初始化方法 必须使用 －(void)pollingInterstitialAd 启动广告轮换
 
 ak:芒果ID
 type:全屏 插屏
 delegate:全屏回调
 */
-(id)noautopollinginitWithAppKey:(NSString *)ak
                            adType:(AdViewType)type
                adMoGoViewDelegate:(id<AdMoGoInterstitialDelegate>) delegate;
...
- (void)adapter:(AdMoGoAdNetworkAdapter *)_adapter didReceiveInterstitialScreenAd:(id)fullScreenAd viewTag:(int)viewTag_;
...
- (void)adapterMoGoInterstitialAdClose:(BOOL)isAutoClose;
